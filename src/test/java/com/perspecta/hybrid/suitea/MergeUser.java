...
public class MergeUser extends BaseTest {
	// make sure that i have my prop and xls file object init
	// before test starts
	
	@Test(dataProvider="getData")
	public void MergeuserTest(Hashtable<String,String> data) throws Exception{
		...
		System.out.println("Merger User administrator");
