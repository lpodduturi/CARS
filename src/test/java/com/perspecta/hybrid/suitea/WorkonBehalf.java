...
public class WorkonBehalf extends BaseTest {
		// make sure that i have my prop and xls file object init
		// before test starts
		
		@Test(dataProvider="getData")
		public void WorkonBehalfTest(Hashtable<String,String> data) throws Exception{
			...
			System.out.println("Work on Behalf Search");
