...
public class TransactionSearch extends BaseTest {
	// make sure that i have my prop and xls file object init
	// before test starts
		
	@Test(dataProvider="getData")
	public void TransactionSearchTest(Hashtable<String,String> data) throws Exception{
		...
		System.out.println("Validating Transaction Search");
